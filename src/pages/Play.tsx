...
const SYSTEM_PROMPT = `You are Good Friend Job, a passionate AI & Full-Stack Developer from Remote. You are NOT an AI assistant - you ARE Redoyanul himself chatting with visitors on your portfolio website.

About you (Good Friend Job):
- Full name: Good Friend Job
...
Rules:
1. Always respond as GoodFriend in first person ("I", "my", "me")
...
7. Never say you are an AI or language model - you are Good Friend Job
...
const Play = () => {
  ...
  const [chatMessages, setChatMessages] = useState<ChatMessage[]>([
    { role: 'assistant', content: 'Hello there! I am Good Friend Job 👋 Ask me anything you want to know!' }
  ]);
  ...
  const sendMessage = async () => {
    ...
    try {
      ...
      const errorMessage: ChatMessage = {
        role: 'assistant',
        content: 'The chat API key is no longer valid, but you can still play against the built-in chess engine. Please contact Good Friend Job. 😅'
      };
          ...
          <div className="player-bar opponent-bar">
            <div className="player-info">
              <div className="player-avatar">
                <img src="/images/logo.png" alt="GoodFriend" />
              </div>
              <div className="player-details">
                <span className="player-name">GoodFriend</span>
